...
const createBGGList = (data) => {
  ...
  items.forEach((item) => {
    ...
    const obj = {
      ...
      source: 'bgg',
      image: item.image ? item.image['#text'] : './wp-content/themes/Ranking-Engine/images/meeple-lime.png',
      thumbnail: item.thumbnail ? item.thumbnail['#text'] : './wp-content/themes/Ranking-Engine/images/meeple-lime.png',
