BEGIN
  ...
  WHERE wp_re_boardgames_update_temp.bgg_year_published IS NOT NULL AND wp_re_boardgames.bgg_year_published IS NULL;
...
SELECT wp_re_boardgames.bgg_id, wp_re_boardgames.bg_name, wp_re_boardgames_update_temp.bgg_year_published
FROM wp_re_boardgames
JOIN wp_re_boardgames_update_temp ON wp_re_boardgames.bgg_id = wp_re_boardgames_update_temp.bgg_id
WHERE wp_re_boardgames_update_temp.bgg_year_published IS NOT NULL AND wp_re_boardgames.bgg_year_published IS NULL;
