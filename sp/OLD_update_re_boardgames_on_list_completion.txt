BEGIN
  ...
  -- Delete items from re_boardgames_update_temp that have fewer than 25 items
  DELETE FROM re_boardgames_update_temp
  WHERE times_ranked < 25 AND bg_id IS NULL;
  ...
  -- Update Pending Games trends to 0 - they won't get a trending score until they are approved
  UPDATE re_boardgames
  SET at_score_trend = 0,
  cy_score_trend = 0,
  d30_score_trend = 0
  WHERE re_boardgames.bg_status = 'P';
